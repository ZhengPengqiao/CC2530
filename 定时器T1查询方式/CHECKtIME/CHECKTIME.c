...
******************************************************************************/
  ...
  int  time3ChannalValue(ENUM_TIME3A4_CHANNAL channal)
  {
    switch(channal)
    {
      case  TIME3A4_CH_0:
  ...
  void time3ChannalClear(ENUM_TIME3A4_CHANNAL channal)
  {
    switch(channal)
    {
      case TIME3A4_CH_0:
  ...
  int  time4ChannalValue(ENUM_TIME3A4_CHANNAL channal)
  {
    switch(channal)
    {
      case TIME3A4_CH_0:
  ...
  void time4ChannalClear(ENUM_TIME3A4_CHANNAL channal)
  {
    switch(channal)
    {
      case TIME3A4_CH_0:
